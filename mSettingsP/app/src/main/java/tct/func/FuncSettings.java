...
public class FuncSettings extends SettingsPreferenceFragment implements
    ...
    //add by tianxin.ren.hz for P10028047 on 20181219 begin
    private long mLastClickTime = 0L;
    private static final int FAST_CLICK_DELAY_TIME = 800;
    //add by tianxin.ren.hz for P10028047 on 20181219 end
...
//            Long contactId = data.getLongExtra("func_contactId",0);
    ...
    private void initView() {
        ...
        //Begin modified by yongjun.zou for XR P23141 7312963 on 2018/09/01
        //begin 20161013 add by xiaojing.wang for task 2825681
        int isFuncOn = 1; //mContext.getResources().getBoolean(R.bool.def_FunC_on) == true ? 1 :0;
        if (1 == Settings.System.getInt(mContext.getContentResolver(),
                "isFuncOn", isFuncOn)) {
        //end 20161013 add by xiaojing.wang for task 2825681
        //End modified by yongjun.zou for XR P23141 7312963 on 2018/09/01
            mChecked = true;
        } else {
            mChecked = false;
        }
    ...
    private void initFuncshortcutsData(){
        ...
        Log.d(TAG,"initFuncShortcutsDataNew111,sTotal = "+totalList);
        if (/*true*/TextUtils.isEmpty(totalList)) {
            List<ShortcutsItem> totalLists = new ArrayList<ShortcutsItem>();
            totalLists = FuncUtilSettings.getDefaultShortcutsItem(mContext, false);
            String sTotal = FuncUtilSettings.saveTotalListJson(mContext,
                    totalLists);
            Log.d(TAG,"initFuncShortcutsDataNew222,sTotal = "+sTotal);
...
//                intent.putExtra("funcParams", 0);
    ...
    private RemoveListener onRemove = new DragSortListView.RemoveListener() {
        ...
        public void remove(int which, boolean flag) {
            ...
            if (item != null) {
                ...
                Log.d(TAG,"remove action,choosedLists :"+choosedLists
        ...
        public void addFuncItem(int position) {
            if (choosedLists.size() < ShortcutsLen) {
                ...
                if (id >= 0) {
                    ...
                    */
                    String packageName = FuncUtilSettings.getItemPkgName(mContext, id);
    ...
    private OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            //add by tianxin.ren.hz for P10028047 on 20181219 begin
            if (System.currentTimeMillis() - mLastClickTime < FAST_CLICK_DELAY_TIME) {
                Log.d(TAG, "cancel continuous click event");
                return;
            }
    ...
    private void getData() {
        ...
        Log.d(TAG,"getData, totalList :"+totalList);
        ...
        Log.d(TAG,"getData, choosedLists :"+choosedLists+
        ",\n"+"alternativeShortcutslists :"+alternativeShortcutslists);
    }
    ...
    private void saveFuncSettingData() {
        ...
        */
        ...
        Log.d(TAG,"saveFuncSettingData,before totalLists:" + totalLists + ",sTotal :" + sTotal);
        FuncUtilSettings.saveInSettingsDatabase(cr,FuncConstant.FUNC_TOTAL_LIST,sTotal);
        Log.i(TAG, "saveInSettingsDatabase,  after: "+FuncUtilSettings.readFromSettingsDatabase(cr,"total_list"));
        Log.d(TAG,"saveFuncSettingData,choosed_list1 :"+choosedLists);
        if (choosedLists != null && choosedLists.size() > 0) {
            ...
            Log.d(TAG,"saveFuncSettingData,choosed_list2 :"+choosed_list);
...
//                }
    ...
    public static class ShortcutsItem {
        ...
        public ShortcutsItem(int id, String name, int iconId, String mainclassName, String packageName, Boolean slected) {
            this.id = id;
            this.name = name;
            this.iconId = iconId;
