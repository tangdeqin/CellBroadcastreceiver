...
public class FuncSettingsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, ">>>needUpdatePkgName=" + needUpdatePkgName);
        // defect 1018427
        ...
        if (!TextUtils.isEmpty(needUpdatePkgName)) {
            ...
            if(TextUtils.isEmpty(totalList)){
                ...
                totalLists = FuncUtilSettings.getDefaultShortcutsItem(context, false);
            ...
            if (!TextUtils.isEmpty(totalList)) {
                ...
                while (iterator.hasNext()) {
                    ...
                    Log.d(TAG, "(String) choosedItem.get(\"name\")=" + (String) choosedItem.getName());
