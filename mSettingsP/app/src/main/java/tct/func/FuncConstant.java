...
public class FuncConstant {
    ...
    protected static final String DEFAULT_SHORTCUTS_SINGLE_ITEM = "single";
    protected static final String DEFAULT_SHORTCUTS_MULTIPLE_ITEM = "multiple";
    protected static final String ATTR_SHORTCUTS_NAME = "name";
    protected static final String ATTR_SHORTCUTS_ICON = "icon";
    ...
    protected static final String ATTR_SHORTCUTS_PACKAGENAME_COUNT = "packageNameCount";
