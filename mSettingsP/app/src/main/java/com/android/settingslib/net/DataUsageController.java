...
public class DataUsageController {
    ...
    public long getDefaultWarningLevel() {
         //Begin modified by miaoliu for XR7107006 on 2018/11/16
        int ResourceId = mContext.getResources().getIdentifier("default_data_warning_level_mb", "integer", "android");
        int warningLevel = ResourceId > 0 ? mContext.getResources().getInteger(ResourceId) :2000;
        return MB_IN_BYTES * warningLevel ;
