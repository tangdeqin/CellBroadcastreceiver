...
public class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    public void disconnect() {
        for (LocalBluetoothProfile profile : mProfiles) {
            //added by zhaoyun.wu for XRP10028658 on 2019-1-3 bg
            new Thread() {
                @Override
                public  void run() {
                    disconnect(profile);
            ...
            //added by zhaoyun.wu for XRP10028658 on 2019-1-3 ed
        }
                ...
                if (batteryLevelPercentageString != null) {
                    ...
                    if (com.android.settingslib.Utils.isAudioModeOngoingCall(mContext)) {
                        ...
                        //[TCT-ROM][BT]Begin added by weijun.pan for XR7233538 on 2019/01/02
                            ...
                            stringRes = R.string.bluetooth_connected_no_headset_no_a2dp_battery_level;
                    ...
                    if (com.android.settingslib.Utils.isAudioModeOngoingCall(mContext)) {
                        ...
                        //[TCT-ROM][BT]Begin added by weijun.pan for XR7233538 on 2019/01/02
                            ...
                            stringRes = R.string.bluetooth_connected_no_a2dp;
                        } else if (!hfpConnected && a2dpConnected) {
                            stringRes = R.string.bluetooth_connected_no_headset;
                        } else {
                            stringRes = R.string.bluetooth_connected;
                        } //[TCT-ROM][BT]End added by weijun.pan for XR7233538 on 2019/01/02
                    } else {
                        if (mIsActiveDeviceHearingAid || mIsActiveDeviceA2dp) {
                            stringRes = R.string.bluetooth_active_no_battery_level;
