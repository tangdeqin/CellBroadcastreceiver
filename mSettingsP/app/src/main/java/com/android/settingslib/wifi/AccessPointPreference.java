...
public class AccessPointPreference extends Preference {
    ...
    protected void updateIcon(int level, Context context) {
        ...
        //Begin modified by chenglong.cai for XR7437880 on 2019-1-30
        Drawable drawable = WifiUtils.getWifiIcon(getContext(),level,getContext().getTheme());
        //NetworkBadging.getWifiIcon(level, NetworkBadging.BADGING_NONE, getContext().getTheme());
        //End modified by chenglong.cai for XR7437880 on 2019-1-30
        //Begin modified by jiabin.zheng.hz for XR6810309 on 2018/08/18
        //if (!mForSavedNetworks && drawable != null) {
        if (drawable != null) {
            //drawable.setTint(Utils.getColorAttr(context, android.R.attr.colorControlNormal));deleted by chenglong.cai for XR7437880 on 2019-1-30
            setIcon(drawable);
        }
        //else {
        //  safeSetDefaultIcon();
