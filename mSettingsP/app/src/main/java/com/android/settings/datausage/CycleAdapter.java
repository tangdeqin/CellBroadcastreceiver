...
import java.util.Objects;//Modified by miaoliu for XR7105303 on 2018/11/15
     ...
     */
     public boolean updateCycleList(NetworkPolicy policy, ChartData chartData) {
        ...
        if (getCount() > 0) {
            ...
            if (!Objects.equals(selectedItem, previousItem)) {//Modified by miaoliu for XR7105303 on 2018/11/15
