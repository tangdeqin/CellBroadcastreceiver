...
public class SoundDualSIM1 extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sim1Vibrate.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                Utils.dataHubSendSub(mContext,KEY_SIM1_VIBRATE);
                Utils.dataHubSoundSendStatus(mContext,KEY_SIM1_VIBRATE,val);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference instanceof RingtonePreference) {
            ...
            Utils.dataHubSendSub(mContext,KEY_SIM1_RINGTONE);//Add by ronghui.yi for task 7448330 data hub 20190218
            return true;
        }
