...
//begin add by zhixiong.lui.hz add for P10027589 20181212
import android.support.v14.preference.SwitchPreference;
import android.support.v7.preference.PreferenceGroup;
//import com.android.settings.widget.MasterCheckBoxPreference;
//end add by zhixiong.lui.hz add for P10027589 20181212
...
public class AppNotificationSettings extends NotificationSettingsBase {
    ...
    private void populateChannelList() {
        ...
        if (mChannelGroupList.isEmpty()) {
            ...
            for (NotificationChannelGroup group : mChannelGroupList) {
                //begin modified by zhixiong.liu.hz add for P10027589 20181212
                PreferenceCategory groupCategory = new PreferenceCategory(getPrefContext());
                ...
                //end modified by zhixiong.liu.hz add for P10027589 20181212
            }
    ...
    //begin modified by zhixiong.liu.hz add for P10027589 20181212
    private void populateSingleChannelPrefs(PreferenceGroup parent,
   ...
   //begin add by zhixiong.liu.hz add for P10027589 20181212
   protected boolean isChannelGroupBlockable(NotificationChannelGroup group) {
    ...
    protected void populateGroupToggle(final PreferenceGroup parent,
        ...
        preference.setTitle(R.string.app_notifications_title);
    ...
    //end add by zhixiong.liu.hz add for P10027589 20181212
    ...
    protected void updateDependents(boolean banned) {
        ...
        //begin modify by wenli for XR 7210577 on 20181206
        if("com.tct.dialer".equals(mPkg)){
            setVisible(mBadge, false);
        } else {
            setVisible(mBadge, !banned);
        }
        //end modify by wenli for XR 7210577 on 20181206
        if (mShowLegacyChannelConfig) {
