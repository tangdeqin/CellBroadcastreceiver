...
public class ReadingModeSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mController = new ColorDisplayController(mContext);
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (KEY_READING_MODE_ADD_APPS.equals(key)) {
            Utils.dataHubSendSub(mContext, key);
        }
        //End add by shilei.zhang for task 7447417 data hub 20190218
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAlwaysEnablePreference) {
            ...
            if((Boolean) newValue == true){
                Utils.dataHubSendSub(mContext,"reading_mode_always_enable");
                Utils.dataHubSendSub(mContext,"reading_mode_always_enable_total");
            }
            ///End add by shilei.zhang for task 7447417 data hub 20190218
            return true;
        }
