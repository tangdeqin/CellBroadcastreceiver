...
public class VibrationDurationSetting extends Activity implements
	...
	private Map<String,Object> mVibraDurationValue = new HashMap<String,Object>();
	//End add by ronghui.yi for task 7448330 data hub 20190218
...
//        }
		...
		mTctDataHubSdkManager = TctDataHubSdkManager.getInstance(getBaseContext());//Add by ronghui.yi for task 7448330 data hub 20190218
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		...
		if (progress >= 0) {
			...
			//Begin add by ronghui.yi for task 7448330 data hub 20190218
			mVibraDurationValue.put("HapticFeedbcak",progress);
			mTctDataHubSdkManager.trackEventInfo(TctDataHubConstants.TYPE_RECORD_BY_DATE, "Sound_HapticFeedbcak_Value", mVibraDurationValue);
			//End add by ronghui.yi for task 7448330 data hub 20190218
		}
	}
