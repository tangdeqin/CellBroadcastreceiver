...
public class DashboardSummary extends InstrumentedFragment
    ...
    private static final boolean DEBUG_TIMING = true;//Modified by miaoliu for XRP10026764 on 2018/12/28
...
//                getActivity().findViewById(R.id.search_bar_container), getLifecycle(), mDashboard);
    ...
    public void onCategoriesChanged() {
        ...
        //begin zhixiong.liu.hz for P10029744 20190125,not forbid first refresh
        //if (isOnCategoriesChangedCalled) {
            rebuildUI();
        //}
        //isOnCategoriesChangedCalled = true;
        //end zhixiong.liu.hz for P10029744 20190125
    }
