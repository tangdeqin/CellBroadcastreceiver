...
public class SettingsSearchProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
       // Log.i("HQTEST", Thread.currentThread().getName());
        ...
        String[] columnNames = new String[]{"1","icon","bread_crumbs","4","5","6","7","8","9","10","11","12"};//Modified by miaoliu for XR7107006 on 2019/2/19
        ...
        while (cursor != null && cursor.moveToNext()){
            ...
            rowData = new Object[]{title, iconUri, breadcrumbs,"","","","","","","","",""};//Modified by miaoliu for XR7107006 on 2019/2/19
