...
public class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    private final GearPreference.OnGearClickListener mDeviceProfilesListener = pref -> {
        ...
        //[TCT-ROM][multi-click]Begin added by weijun.pan for XR P24454 on 2018/12/27
        if (isFastClick()) { //[TCT-ROM][BT]Modified by weijun.pan for XR P10029909 on 2019/01/23
            return;
        } //[TCT-ROM][multi-click]End added by weijun.pan for XR P24454 on 2018/12/27
        if (!useDetailPage) {
    ...
    //[TCT-ROM][BT]Begin added by weijun.pan for XR7233538 on 2019/01/02
    @Override
    ...
    //[TCT-ROM][BT]End added by weijun.pan for XR7233538 on 2019/01/02

    //[TCT-ROM][multi-click]Begin added by weijun.pan for XR P10029909 on 2019/01/28
    @Override
    public void onResume() {
        super.onResume();
        lastClickTime = 0;
    } //[TCT-ROM][multi-click]End added by weijun.pan for XR P10029909 on 2019/01/28

    //[TCT-ROM][multi-click]Begin added by weijun.pan for XR P10029909 on 2019/01/23
    ...
    //[TCT-ROM][multi-click]End added by weijun.pan for XR P10029909 on 2019/01/23
}
