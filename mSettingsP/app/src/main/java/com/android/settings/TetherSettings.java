...
public class TetherSettings extends RestrictedSettingsFragment
   ...
   /* //Begin added by yucheng.luo for XR6610449 on 18-7-26
                ...
                if (mBluetoothEnableForTether) {
                    switch (intent
                        ...
                        case BluetoothAdapter.STATE_ON:
                            //Begin added by taoyang.hz for XR7446668 on 2019/02/18
                            BluetoothAdapter adapter = BluetoothAdapter.getDefaultAdapter();
                            if (adapter != null) {
                                adapter.getProfileProxy(content, mProfileServiceListener,
                                        BluetoothProfile.PAN);
                            }
                            //End added by taoyang.hz for XR7446668 on 2019/02/18
    ...
    //Begin added by taoyang.hz for XR7403049 on 2019/01/28
    private static final int MSG_UPDATE_STATE = 0;
    private static final int UPDATE_STATE_DELAYEDTIME_VALUE = 100;
    ...
    //End added by taoyang.hz for XR7403049 on 2019/01/28
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mUsbTether) {
            ...
            if (mBluetoothTether.isChecked()) {
                ...
                //Begin added by taoyang.hz for XR7403049 on 2019/01/28
                if (mBluetoothTether.isChecked()) {
                    mDelayedHandler.sendMessageDelayed(mDelayedHandler.obtainMessage(MSG_UPDATE_STATE), UPDATE_STATE_DELAYEDTIME_VALUE);
                }
                //End added by taoyang.hz for XR7403049 on 2019/01/28
            }
        }
