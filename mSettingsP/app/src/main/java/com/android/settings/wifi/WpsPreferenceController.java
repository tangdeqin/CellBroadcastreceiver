...
public class WpsPreferenceController extends AbstractPreferenceController
    ...
    public boolean isAvailable() {
        ...
        //[TCT-ROM][wifi]Begin modified by jiabin.zheng.hz for XR7134625 on 2018/11/16
        return true;
        //[TCT-ROM][wifi]Begin modified by jiabin.zheng.hz for XR7134625 on 2018/11/16
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        //[TCT-ROM][wifi]Begin modified by jiabin.zheng.hz for XR7134625 on 2018/11/16
        if (!isAvailable()) {
            mWpsPushPref.setVisible(false);
            mWpsPinPref.setVisible(false);
            return;
        }
        //[TCT-ROM][wifi]End modified by jiabin.zheng.hz for XR7134625 on 2018/11/16
