...
public class BluetoothDetailsButtonsController extends BluetoothDetailsController {
    ...
    private void onForgetButtonPressed() {
        //Begin added by chenglong.cai for XR7398605 on 2019-2-13
        if (mFragment.getFragmentManager().findFragmentByTag(ForgetDeviceDialogFragment.TAG)!=null)
            return;
        //End added by chenglong.cai for XR7398605 on 2019-2-13
