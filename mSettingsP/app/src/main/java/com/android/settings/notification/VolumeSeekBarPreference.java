...
import com.android.settings.Utils;//Add by ronghui.yi for task 7448330 data hub 20190219
...
public class VolumeSeekBarPreference extends SeekBarPreference {
    ...
    private Context mContext;//Add by ronghui.yi for task 7448330 data hub 20190219
    @VisibleForTesting
    ...
    public VolumeSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;//Add by ronghui.yi for task 7448330 data hub 20190219
        setLayoutResource(R.layout.preference_volume_slider);
        mAudioManager = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        //Modified by ronghui.yi for 7218056 on 2018-12-12 begin
        ...
        //Modified by ronghui.yi for 7218056 on 2018-12-12 end
        init();
    }
        ...
        final SeekBarVolumizer.Callback sbvc = new SeekBarVolumizer.Callback() {
            ...
            public void onSampleStarting(SeekBarVolumizer sbv) {
                if (mCallback != null) {
                    ...
                    int mLastVolume = mAudioManager.getLastAudibleStreamVolume(mStream);
                    Utils.dataHubVolumeStreamSendValues(mContext, mStream, mLastVolume);
