...
public class BootSoundPreferenceController extends AbstractPreferenceController
    ...
    private Context mContext;//Add by ronghui.yi for task 7448330 data hub 20190218

    public BootSoundPreferenceController(Context context) {
        super(context);
        mContext = context;//Add by ronghui.yi for task 7448330 data hub 20190218
    }
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (KEY_BOOT_SOUNDS.equals(preference.getKey())) {
            ...
            Utils.dataHubSoundSendStatus(mContext,"boot_sounds", switchPreference.isChecked());//Add by ronghui.yi for task 7448330 data hub 20190218
            //[TCT-ROM][ power on/off ringtone]Begin modified by junliang.liu for XR6703329 on 20180815
