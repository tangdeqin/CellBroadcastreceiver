...
public class WifiMasterSwitchPreferenceController extends AbstractPreferenceController
    ...
    public void onStart() {
        ...
        //[TCT-ROM] [BUG fix] chuanhang.ren add for P10030210 on 2019-01-28 begin
        if(mSummaryHelper != null && mWifiPreference != null) {
            WifiManager wifiManager = (WifiManager) mContext.getSystemService(Context.WIFI_SERVICE);
            int wifiState = wifiManager.getWifiState();
            if(wifiState == WifiManager.WIFI_STATE_DISABLED || wifiState == WifiManager.WIFI_STATE_DISABLING) {
                mWifiPreference.setSummary(mSummaryHelper.getSummary());
            }
        }
        //[TCT-ROM] [BUG fix] chuanhang.ren add for P10030210 on 2019-01-28 end
