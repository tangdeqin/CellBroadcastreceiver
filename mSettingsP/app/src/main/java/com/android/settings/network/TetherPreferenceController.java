...
public class TetherPreferenceController extends AbstractPreferenceController implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        //Begin deleted by weijun.pan for XR7311423 on 2019/01/05
        /*
        if (mBluetoothAdapter != null) {
            mBluetoothAdapter.getProfileProxy(mContext, mBtProfileServiceListener,
                    BluetoothProfile.PAN);
        }*/ //End deleted by weijun.pan for XR7311423 on 2019/01/05
    }

    @Override
    public void onResume() {
        //Begin added by weijun.pan for XR7311423 on 2019/01/05
        if (mBluetoothAdapter != null &&
        ...
        } //End added by weijun.pan for XR7311423 on 2019/01/05
    ...
    @Override
    public void onPause() {
        //[TCT-ROM][BT] Begin added by weijun.pan for XR P10028146 on 2018/12/21
        ...
        } //[TCT-ROM][BT] End added by weijun.pan for XR P10028146 on 2018/12/21
        if (mAirplaneModeObserver != null) {
    ...
    public void onDestroy() {
        //[TCT-ROM][BT] Begin deleted by weijun.pan for XR P10028146 on 2018/12/21
        /*
        final BluetoothProfile profile = mBluetoothPan.getAndSet(null);
        if (profile != null && mBluetoothAdapter != null) {
            mBluetoothAdapter.closeProfileProxy(BluetoothProfile.PAN, profile);
        } */
        //[TCT-ROM][BT] End deleted by weijun.pan for XR P10028146 on 2018/12/21
    }
