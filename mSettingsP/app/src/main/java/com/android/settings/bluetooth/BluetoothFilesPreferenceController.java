...
public class BluetoothFilesPreferenceController extends AbstractPreferenceController
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        if (KEY_RECEIVED_FILES.equals(preference.getKey())) {
            //[TCT-ROM][multi-click]Begin added by weijun.pan for XR P10026992 on 2018/11/29
            if (isFastClick()) {
                return false;
            } //[TCT-ROM][multi-click]End added by weijun.pan for XR P10026992 on 2018/11/29
    ...
    //[TCT-ROM][multi-click]Begin added by weijun.pan for XR P10026992 on 2018/11/29
    private final int MIN_DELAY_TIME = 450;
