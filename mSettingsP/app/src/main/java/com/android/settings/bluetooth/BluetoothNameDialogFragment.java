...
abstract class BluetoothNameDialogFragment extends InstrumentedDialogFragment
    ...
    //Begin modified by weijun.pan for XR P10029914 on 2019/01/23
    private static final int BLUETOOTH_NAME_MAX_LENGTH_BYTES = 247;
    //End modified by weijun.pan for XR P10029914 on 2019/01/23
    ...
    void updateDeviceName() {
        ...
        if (name != null) {
            ...
            //[TCT-ROM][BT]Begin added by weijun.pan for XR7235741 on 2018/12/24
            if (!TextUtils.isEmpty(name)) {
                mDeviceNameView.setSelection(name.length());
            } //[TCT-ROM][BT]End added by weijun.pan for XR7235741 on 2018/12/24
        }
    }
