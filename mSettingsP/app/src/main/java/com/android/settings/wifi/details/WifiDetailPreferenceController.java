...
public class WifiDetailPreferenceController extends AbstractPreferenceController
    ...
    private void refreshRssiViews() {
        ...
        Drawable wifiIcon = WifiUtils.getWifiIcon(mContext,iconSignalLevel,mContext.getTheme()).mutate();
        //NetworkBadging.getWifiIcon(iconSignalLevel, NetworkBadging.BADGING_NONE, mContext.getTheme()).mutate();
