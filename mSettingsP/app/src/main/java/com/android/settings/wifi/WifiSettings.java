...
public class WifiSettings extends RestrictedSettingsFragment
    ...
    private static final String WIFI_WAKEUP_AVAILABLE =  "wifi_wakeup_available";
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo info) {
            ...
            if (preference instanceof LongPressAccessPointPreference) {
                ...
                if (mSelectedAccessPoint.isSaved()) {
                   ...
                   //Begin deleted by yucheng.luo for P10028326 on 18-12-27
                   ...
                   //End deleted by yucheng.luo for P10028326 on 18-12-27
                }
            }
    }
    ...
    private void removeConnectedAccessPointPreference() {
        Log.i(TAG, "removeConnectedAccessPointPreference: ",new Exception());//add by ruohui.huang for P10029790 on 20190128
    ...
    private void setAdditionalSettingsSummaries() {
        ...
        //Begin modified by jiabin.zheng.hz for XR7212378 on 2018/12/04
        //int resId = getResources().getIdentifier("config_wifi_wakeup_available","integer","android");
        final int defaultWakeupAvailable = 0;//getResources().getInteger(resId);zhixiong.liu.hz remove for temp because fc
        //End modified by jiabin.zheng.hz for XR7212378 on 2018/12/04
        //End modified by jiabin.zheng.hz for XR6873798 on 2018/08/28
        boolean wifiWakeupAvailable = Settings.Global.getInt(
                getContentResolver(), WIFI_WAKEUP_AVAILABLE, defaultWakeupAvailable)
                == 1;
