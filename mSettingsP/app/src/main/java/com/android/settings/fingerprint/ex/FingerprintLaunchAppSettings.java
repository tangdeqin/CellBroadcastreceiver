...
//Begin added by jiatang.ye for XRP10029549 on 19-1-17
import android.content.pm.PackageInfo;
import android.content.pm.PackageManager;
//End added by jiatang.ye for XRP10029549 on 19-1-17
    ...
    public static class FingerprintLaunchAppFragment extends SettingsPreferenceFragment implements RadioButtonPreferenceEx.OnClickListener {
        ...
        private void initPreference() {
           ...
           //End modified by jinlong.lu for XR5854853 on 18-1-19
            ...
            LaunchAppInfo launchAppInfo = FingerprintLaunchAppHelper.getLauncherAppInfo(mContext, mFingerId,false);
            //End modified by jinlong.lu for XRP10029175 on 19-1-11

            //Begin added by jiatang.ye for XRP10029549 on 19-1-17
            boolean isSoundRecorderInstalled = false;
            ...
            if (packageInfos != null) {
                for (PackageInfo info :
                    ...
                    if ("com.tct.soundrecorder".equals(packageName)) {
                        isSoundRecorderInstalled = true;
                        break;
                    }
                }
            }
            ...
            for (int i = 0; i < mLaunchAppList.size(); i++) {
                ...
                //Begin added by jiatang.ye for XRP10029549 on 19-1-17
                if ("func_start_sound_record".equals(funcStr) && !isSoundRecorderInstalled){
                    continue;
                }
                //End added by jiatang.ye for XRP10029549 on 19-1-17
        ...
        //Begin added by jinlong.lu for XRP10029175 on 19-1-11
        void shotToastTips(int strId) {
            if (showToast != null) {
                showToast.cancel();
            }
            Resources resources = mContext.getResources();
            showToast = Toast.makeText(mContext, strId,
                    Toast.LENGTH_SHORT);
            showToast.show();
        }
        //End added by jinlong.lu for XRP10029175 on 19-1-11
        ...
        public void onRadioButtonClicked(RadioButtonPreferenceEx emiter) {
            ...
            //Begin added by jinlong.lu for XRP10029175 on 19-1-11
            boolean targetAppIsDisable = FingerprintLaunchAppHelper.isAppDisableCheck(mContext,launchApp);
            if (targetAppIsDisable) {
                shotToastTips(R.string.shortcuts_app_disable_warning);
                return;
            }
            //End added by jinlong.lu for XRP10029175 on 19-1-11
            switch (launchApp) {
