...
import com.android.settings.Utils;//Add by ronghui.yi for task 7448330 data hub 20190218
...
public class SoundDualSIM2 extends SettingsPreferenceFragment {
    ...
    private static final String  SIM2_VIBRATE_WHEN_RINGING = "sim2_vibrate_when_ringing";
    static final int TYPE_SIM2_RINGTONE = 32;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sim2Ringtone.setRingtoneType(TYPE_SIM2_RINGTONE);//[TCT-ROM][ Sound]Action by junliang.liu for XR7099419 on 20181104
        ...
        sim2Vibrate.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                Utils.dataHubSendSub(mContext,KEY_SIM2_VIBRATE);
                Utils.dataHubSoundSendStatus(mContext,KEY_SIM2_VIBRATE,val);
                //End add by ronghui.yi for task 7448330 data hub 20190218
                return Settings.System.putInt(getContentResolver(),
                       SIM2_VIBRATE_WHEN_RINGING,
                        val ? 1 : 0);
            }
        });
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference instanceof RingtonePreference) {
            ...
            Utils.dataHubSendSub(mContext,KEY_SIM2_RINGTONE);//Add by ronghui.yi for task 7448330 data hub 20190218
            return true;
        }
    ...
    public int getMetricsCategory() {
        return MetricsEvent.SOUND; //zhixiong.liu may check
    }
    ...
    private CharSequence updateRingtoneName() {
        ...
        Uri ringtoneUri = RingtoneManager.getActualDefaultRingtoneUri(mContext, TYPE_SIM2_RINGTONE);
        CharSequence summary = mContext.getString(R.string.unknown);//[TCT-ROM][ Sound]Action by junliang.liu for XR7099419 on 20181104
        // Is it a silent ringtone?
        if (ringtoneUri == null) {
            summary = mContext.getString(R.string.ringtone_silent);//[TCT-ROM][ Sound]Action by junliang.liu for XR7099419 on 20181104
        } else {
            Cursor cursor = null;
            try {
