...
public class LocationSettings extends LocationSettingsBase
    ...
    private PreferenceScreen createPreferenceHierarchy() {
       ...
       //[TCT-ROM][Adapt Android P]Begin modified by yucheng.luo for XR7201551 on 18-12-1
        ...
        //End added by jiabin.zheng.hz for XR6619987 on 2018/08/13
       //[TCT-ROM][Adapt Android P]End modified by yucheng.luo for XR7201551 on 18-12-1
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        if (isChecked) {
            setLocationMode(android.provider.Settings.Secure.LOCATION_MODE_HIGH_ACCURACY);//zhixiong.liu may check
        } else {
