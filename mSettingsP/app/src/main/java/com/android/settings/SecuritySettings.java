...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    //modified by tianxin.ren.hz for P10030069 on 20190128 begin
    private RestrictedSwitchPreference mUnifyProfile;
    //modified by tianxin.ren.hz for P10030069 on 20190128 end
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        //begin add by zhixiong.liu.hz for task 7447417 data hub 20190214    
        Utils.dataHubSendSub(getContext(),key);
        //end add by zhixiong.liu.hz for task 7447417 data hub 20190214 
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (KEY_VISIBLE_PATTERN_PROFILE.equals(key)) {
            ...
            //begin add by zhixiong.liu.hz for task 7447417 data hub 20190214    
            Utils.dataHubSendTroggle(getContext(),"PASS",(Boolean)value);
            //end add by zhixiong.liu.hz for task 7447417 data hub 20190214 
    ...
    private static class SecuritySearchIndexProvider extends BaseSearchIndexProvider {
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!lockPatternUtils.isSecure(MY_USER_ID)) {
                ...
                //Begin added by xuhui.li.hz for XR P10029526 2019/01/17
                keys.add("visiblepattern");
                keys.add("lock_after_timeout");
                keys.add("power_button_instantly_locks");
            } else {
            ...
            //End added by xuhui.li.hz for XR P10029526 2019/01/17
    ...
    public static class SecuritySubSettings extends SettingsPreferenceFragment
        ...
        private void setupLockAfterPreference() {
            ...
            if (mDPM != null) {
               ...
               final long adminTimeout = mDPM
                        .getMaximumTimeToLock(null,UserHandle.myUserId());
        ...
        private static int getResIdForLockUnlockSubScreen(Context context,
            ...
            //[TCT-ROM] [Settings] Modified by jianhao.zeng for p10026863 on 2018-12-03 begin
            /*else if (!lockPatternUtils.isLockScreenDisabled(MY_USER_ID)) {
                return R.xml.security_settings_slide_sub;
            }
            return 0;*/
            return R.xml.security_settings_slide_sub;
            //[TCT-ROM] [Settings] Modified by jianhao.zeng for p10026863 on 2018-12-03 end
        }
