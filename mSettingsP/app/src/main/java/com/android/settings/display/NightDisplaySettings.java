...
//Begin add by shilei.zhang for task 7447417 data hub 20190218
import com.android.settings.Utils;
//End add by shilei.zhang for task 7447417 data hub 20190218
/**
...
public class NightDisplaySettings extends SettingsPreferenceFragment
     implements ColorDisplayController.Callback, Preference.OnPreferenceChangeListener ,MyRadioButtonPreference.OnClickListener{   
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (PREF_AUTO_SCHEDULE.equals(key)
                || PREF_SCHEDULE_PLAN.equals(key)
                || KEY_ECM_TURN_ON_NOW.equals(key)
                || "ecm_color_space_normal_theme".equals(key)
                || "ecm_color_space_night_theme".equals(key)
        ){
            Utils.dataHubSendSub(context, key);
        }
        //End add by shilei.zhang for task 7447417 data hub 20190218
    ...
    public void onColorTemperatureChanged(int colorTemperature) {
        //Begin add by shilei.zhang for task 7447417 data hub 20190218
        Utils.dataHubSendSub(context, "ecm_ColorTemperature");
        Utils.dataHubSendStringsByDate(context, "ecm_ColorTempemperture_Vaule",colorTemperature+"");
        //End add by shilei.zhang for task 7447417 data hub 20190218
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mTurnOnNow) {
            ...
            //Begin add by shilei.zhang for task 7447417 data hub 20190218
            Utils.dataHubSendTroggle(context,"emc_auto_schedule",(Boolean) newValue);
            //End add by shilei.zhang for task 7447417 data hub 20190218
            ...
            if(!mAutoSchedule.isChecked()){
                mController.setAutoMode(ColorDisplayController.AUTO_MODE_DISABLED);
            }else{
                ...
                if (1 == temp) {
                    ...
                    mController.setAutoMode(ColorDisplayController.AUTO_MODE_TWILIGHT);
                }
            }
            updateRadioButtonPreferenceStatus();
        }
    ...
    private void updatePref()
    {
        ...
        if(ColorDisplayController.AUTO_MODE_CUSTOM ==autoMode
                || ColorDisplayController.AUTO_MODE_TWILIGHT == autoMode){
            if (ColorDisplayController.AUTO_MODE_CUSTOM == autoMode){
