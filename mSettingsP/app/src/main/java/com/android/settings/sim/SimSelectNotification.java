...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //remove by zhixiong.liu.hz  code for move to simsettings for P10029371 20190104
        //begin zhixiong.liu.hz for defect 7098359 20181105
   ...
   private void setSimNotification(Context context, int slot) {
        ...
        NotificationChannel SimNotificationChannel = new NotificationChannel(SIM_NOTIFICATION_CHANNEL,
