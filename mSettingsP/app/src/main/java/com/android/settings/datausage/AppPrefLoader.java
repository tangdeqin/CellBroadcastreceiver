    ...
    public ArraySet<Preference> loadInBackground() {
        ...
        for (int i = 1, size = mPackages.size(); i < size; i++) {
            try {
                ...
                //begin zhixiong.liu.hz add for P10028262 20181222 change the layout 
                preference.setLayoutResource(R.layout.preference_data);
                //end zhixiong.liu.hz add for P10028262 20181222
