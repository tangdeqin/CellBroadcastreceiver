...
//Begin added by jinlong.lu for XR7086584 on 18-11-2
import android.content.BroadcastReceiver;
import android.content.IntentFilter;
//End added by jinlong.lu for XR7086584 on 18-11-2
/**
...
public class FingerprintSettings extends SubSettings {
    ...
    //End added by jinlong.lu for XR6618444 on 18-7-31
        ...
        //End added by jinlong.lu for XR7086584 on 18-11-2
        //Begin added by jinlong.lu for XR7086584 on 18-11-10
        private boolean isChildSettings;
        //End added by jinlong.lu for XR7086584 on 18-11-10
       ...
       //End added by jinlong.lu for XR6618444 on 18-7-31
        ...
        private PreferenceScreen createPreferenceHierarchy() {
            ...
            //Begin modified by jinlong.lu for XR7086584 on 18-11-7
            ...
            //End modified by jinlong.lu for XR7086584 on 18-11-7
            ...
            for (int i = 0; i < fingerprintCount; i++) {
              ...
              //End modified by jinlong.lu for XR6618444 on 18-7-31
                ...
                if (allowUnlock) {
                    ...
                    LaunchAppInfo appInfo =FingerprintLaunchAppHelper.getLauncherAppInfo(getActivity(), item.getFingerId(),true);
        ...
        public void onPause() {
            ...
            //Begin added by jinlong.lu for XR7086584 on 18-11-10
            if (!isChildSettings && isConfirmPassword) {
                Log.d(TAG, "Fingerprint manager on pause");
                getActivity().finish();
            }
            //End added by jinlong.lu for XR7086584 on 18-11-10
        }
        ...
        public boolean onPreferenceTreeClick(Preference pref) {
            ...
            if (KEY_FINGERPRINT_ADD.equals(key)) {
                ...
                //Begin modified by jinlong.lu for XR7086584 on 18-11-2
                //Begin modified by jinlong.lu for XR6618444 on 18-7-31
                //show google default
                 showRenameDialog(fp);
                //showRenameDeleteDialog(fp);
                //End modified by jinlong.lu for XR6618444 on 18-7-31
                //End modifiedmodified by jinlong.lu for XR7086584 on 18-11-2
            }
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (KEY_FINGERPRINT_ENABLE_KEYGUARD_TOGGLE.equals(key)) {
                ...
                //Begin added by jinlong.lu for XR6312208 on 18-5-9
                //Begin modified by jinlong.lu for XR7086584 on 18-11-7
                //changed switch off not need to confirm password
                ...
                if (isAppsLockOn) {
                    //has password for app lock
                    if (switchOn) {//wanna switch on fingerprint unlock app,cinfirm app lock password
                        try {
