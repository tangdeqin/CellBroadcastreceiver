...
public class AlarmVolumePreferenceController extends
    ...
    private final class H extends Handler {
        ...
        private static final int UPDATE_RINGER_MODE = 2;//Added by nanbing.zou for P10027505 on 2018-12-10
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ALARM_VOLUME_UPDATE:
                    updatePreferenceIcon();
                    break;
                //Added by nanbing.zou for P10027505 on 2018-12-10 begin
                case UPDATE_RINGER_MODE:
                    updatePreferenceIcon();
                    break;
                //Added by nanbing.zou for P10027505 on 2018-12-10 end
            }
        }
    }
    private  class AlarmReceiver extends BroadcastReceiver {
        ...
        public void register(boolean register) {
            ...
            if (register) {
                ...
                filter.addAction(AudioManager.INTERNAL_RINGER_MODE_CHANGED_ACTION);//Added by nanbing.zou for P10027505 on 2018-12-10
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (AudioManager.VOLUME_CHANGED_ACTION.equals(action)) {
                ...
                //Modified by nanbing.zou for P10027505 on 2018-12-10 begin
            }else if (AudioManager.INTERNAL_RINGER_MODE_CHANGED_ACTION.equals(action)){
                mHandler.sendEmptyMessage(H.UPDATE_RINGER_MODE);
            }
            //Modified by nanbing.zou for P10027505 on 2018-12-10 end
        }
    }
    //Added by yingying.qiao.hz for defect10024579 on 2018-10-22 end
