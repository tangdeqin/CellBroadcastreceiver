...
public class WifiEnabler implements SwitchWidgetController.OnSwitchChangeListener  {
    ...
    public boolean onSwitchToggled(boolean isChecked) {
        //begin add by zhixiong.liu.hz for task 7447417 data hub 20190214    
        Utils.dataHubSendTroggle(mContext,"WIFI",isChecked);
        //end add by zhixiong.liu.hz for task 7447417 data hub 20190214 
