 ...
 */
public class AvailableMediaDeviceGroupController extends AbstractPreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        Log.d("jiabin", "displayPreference()");
