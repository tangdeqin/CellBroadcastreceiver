...
public class SimSettings extends RestrictedSettingsFragment implements Indexable {
    ...
    public void onCreate(final Bundle bundle) {
        ...
        if(Utils.checkPackageExist(mContext, "com.tct.simsettings")){
            Intent intent = new Intent();
            intent.setAction("com.tct.simsettings.SIM_SETTINGS");
    ...
    private void updateSmsValues() {
        ...
        */
        ...
        boolean isRadioOn1 = false;
        if(SubscriptionManager.getSubId(0) != null ){
            isRadioOn1 = TclInterfaceAdapter.isRadioOn(SubscriptionManager.getSubId(0)[0], mContext);
        }
        boolean isRadioOn2 = false;
        if(SubscriptionManager.getSubId(1) != null ){
            isRadioOn2 = TclInterfaceAdapter.isRadioOn(SubscriptionManager.getSubId(1)[0], mContext);
        }
        ...
        */
        ...
        if (sir != null) {
            if (!tm.getDataEnabled(mDDSubId)) {
                simPref.setSummary(mContext.getResources().getString(R.string.sim_calls_cellular_data_disabled));
            } else {
                simPref.setSummary(sir.getDisplayName());
            }
        } else if (sir == null) {
