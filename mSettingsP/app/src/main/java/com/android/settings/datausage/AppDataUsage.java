...
public class AppDataUsage extends DataUsageBase implements Preference.OnPreferenceChangeListener,
    ...
    private void bindData() {
        ...
        //Begin modified by miaoliu for XRP10028370 on 2018/12/24
        mTotalUsage.setSummary(com.android.settings.Utils.formatDataUsage(context, totalBytes));
        mForegroundUsage.setSummary(com.android.settings.Utils.formatDataUsage(context, foregroundBytes));
        mBackgroundUsage.setSummary(com.android.settings.Utils.formatDataUsage(context, backgroundBytes));
        //End modified by miaoliu for XRP10028370 on 2018/12/24
    }
