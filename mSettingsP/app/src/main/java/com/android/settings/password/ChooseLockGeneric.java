...
//Begin added by xuhui.li.hz for XR 7405877,7433245 2019/01/28
import android.security.Credentials;
import com.android.internal.net.VpnProfile;
import com.android.internal.util.ArrayUtils;
//End added by xuhui.li.hz for XR 7405877,7433245 2019/01/28
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    //End modified by jinlong.lu for XR6618444 on 18-8-1
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (mPasswordConfirmed) {
                ...
                boolean managedProfileWithUnifiedLock =
                        UserManager.get(getActivity()).isManagedProfile(mUserId)
                        && !mLockPatternUtils.isSeparateProfileChallengeEnabled(mUserId);
                 //zhixiong.liu.hz  tmp change for change witch lock settings xr7070928 20181030
                 //Begin modified by jinlong.lu for XR6618444 on 18-8-1
        ...
        protected void disableUnusablePreferencesImpl(final int quality,
            ...
            //Begin added by xuhui.li.hz for XR 7405877,7433245 2019/01/28
            if(hasVpnProfiles(mKeyStore)) {
                findPreference(ScreenLockType.NONE.preferenceKey).setEnabled(false);
                findPreference(ScreenLockType.SWIPE.preferenceKey).setEnabled(false);
            }
            //End added by xuhui.li.hz for XR 7405877,7433245 2019/01/28
        }

        //Begin added by xuhui.li.hz for XR 7405877,7433245 2019/01/28
        private boolean hasVpnProfiles(KeyStore keyStore, int... excludeTypes) {
