...
public class BluetoothDeviceDetailsFragment extends RestrictedDashboardFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        //Begin modified by chenglong.cai for XR7398605 on 2019-2-13
        if (menuItem.getItemId() == EDIT_DEVICE_NAME_ITEM_ID 
                && getFragmentManager().findFragmentByTag(RemoteDeviceNameDialogFragment.TAG) == null) {
        //End modified by chenglong.cai for XR7398605 on 2019-2-13
