...
public class ResetAppsHelper implements DialogInterface.OnClickListener,
    ...
    private void resetDefaultHome() {    
        ...
        if("".equals(DEFAULT_PACKAGE_NAME) || "".equals(DEFAULT_ACTIVITY_NAME)){
            //begin modified by zhixiong.liu.hz for P10029054 20190107
            DEFAULT_PACKAGE_NAME = "com.tcl.android.launcher";
            DEFAULT_ACTIVITY_NAME = "com.tcl.android.launcher.Launcher";
            //end modified by zhixiong.liu.hz for P10029054 20190107
        }
