...
public class AndroidBeam extends InstrumentedPreferenceFragment
    ...
    // BEGIN P10029399 Added by binjian.tu on 2019/01/14
    private static final String TAG = "AndroidBeam";
    // END P10029399 Added by binjian.tu on 2019/01/14
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // BEGIN P10029399 Added by binjian.tu on 2019/01/14
        if (null == mNfcAdapter) {
            Log.e(TAG, "NfcAdapter is null, which means device doesn't have NFC chipset, abort.");
            getActivity().finish();
            return;
        }
        // END P10029399 Added by binjian.tu on 2019/01/14
