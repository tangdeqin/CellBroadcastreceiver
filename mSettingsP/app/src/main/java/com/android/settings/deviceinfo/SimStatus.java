...
public class SimStatus extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        //begin add by zhixiong.liu.hz for XR P10040183 20180719
        if(mRes.getBoolean(R.bool.def_hide_carrier_operator_name)){
            removePreferenceFromScreen(KEY_OPERATOR_NAME);
        }
        //end add by zhixiong.liu.hz for XR P10040183 20180719
    }
    ...
    private void updateNetworkType() {
        ...
        //Begin added by miaoliu for XR7107006 on 2019/1/27
        ...
        //End added by miaoliu for XR7107006 on 2019/1/27
    ...
    private void updatePreference() {
        ...
        setSummaryText(KEY_IMEI_SV, mPhone.getDeviceSvn());
         Log(TAG,"formattedNumber:"+DeviceInfoUtils.getFormattedPhoneNumber(getContext(), mSir));
         Log(TAG,"Imei:"+mPhone.getImei());
        Log(TAG,"ImeiSVN:"+mPhone.getDeviceSvn());
