...
import com.android.settings.Utils;//Added by miaoliu for XR7107006 on 2018/11/30
public class BillingCycleSettings extends DataUsageBase implements
    ...
    private void updatePrefs() {
        ...
        if (warningBytes != WARNING_DISABLED) {
            mDataWarning.setSummary(Utils.formatDataUsage(getContext(), warningBytes));//Modified by miaoliu for XR7107006 on 2018/11/30
        ...
        if (limitBytes != LIMIT_DISABLED) {
            mDataLimit.setSummary(Utils.formatDataUsage(getContext(), limitBytes));//Modified by miaoliu for XR7107006 on 2018/11/30
