...
public class DataUsageList extends DataUsageBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //begin add by zhixiong.liu.hz for task 7447417 data hub 20190214 
        Utils.dataHubSendSub(context,"cellular_data_usage_"+mSubId);
        //end add by zhixiong.liu.hz for task 7447417 data hub 20190214  
    }
    ...
    private void updateDetailData() {
        ...
        final String totalPhrase = com.android.settings.Utils.formatDataUsage(context, totalBytes);//Modified by miaoliu for XRP10028370 on 2018/12/24
