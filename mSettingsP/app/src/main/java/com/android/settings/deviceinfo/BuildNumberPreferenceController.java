    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            try {
                 ...
                 String rom_ver = SystemProperties.get("ro.rom.yinfo");//zhixiong.liu.hz for rom version info P24071 20181008
                 ...
                 //begin zhixiong.liu.hz for rom version info P24071 20181008
                     ...
                     buildVersion = sys_ver.substring(1, 4)+sys_ver.substring(6, 7)+"+"+sys_ver.substring(4, 8);
                     preference.setSummary(BidiFormatter.getInstance().unicodeWrap(buildVersion));
                 }
                 else if(!TextUtils.isEmpty(rom_ver) && displayType == 0x03){  
                     buildVersion = rom_ver.substring(1, 4) + rom_ver.substring(6, 7) + "+"
                                     + rom_ver.substring(4, 6) + rom_ver.substring(7, 8);
                     preference.setSummary(BidiFormatter.getInstance().unicodeWrap(buildVersion));
                 }
