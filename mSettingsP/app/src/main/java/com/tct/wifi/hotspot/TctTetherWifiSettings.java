...
public class TctTetherWifiSettings extends SettingsPreferenceFragment
        ...
        DataSaverBackend.Listener,TctButtonPreference.OnButtonClickCallback{
    ...
    //Begin modified by yucheng.luo for XR7098003 on 18-11-24
    private List<String> blockClientList;
    //End modified by yucheng.luo for XR7098003 on 18-11-24
    ...
    public void onCreate(Bundle icicle) {
        ...
        //Begin added by chenglong.cai for XR7215097 on 2018-12-24
        mStopTethering = (mWifiManager.getWifiApState()==WifiManager.WIFI_AP_STATE_ENABLED||mWifiManager.getWifiApState()==WifiManager.WIFI_AP_STATE_ENABLING)
                ?false:true;
        //End added by chenglong.cai for XR7215097 on 2018-12-24
...
//        }
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
              ...
              //Begin deleted by yucheng.luo for XR7432748 on 19-1-29
                //Begin added by chenglong.cai for XR7215097 on 2018-12-24
                ...
                //End added by chenglong.cai for XR7215097 on 2018-12-24
              //End deleted by yucheng.luo for XR7432748 on 19-1-29
                //Begin added by yucheng.luo for XR7031036 on 18-9-28
                handleWifiApStateChanged(intent.getIntExtra(WifiManager.EXTRA_WIFI_AP_STATE,
                        WifiManager.WIFI_AP_STATE_FAILED));
                //End added by yucheng.luo for XR7031036 on 18-9-28
            }else if(TctWifiSettingsUtils.TCT_WIFI_HOTSPOT_CLIENTS_CHANGED_ACTION.equals(action)
                    || "android.net.wifi.WIFI_HOTSPOT_CLIENTS_IP_READY".equals(action)){
                    if (mStopTethering) {
                        //Begin deleted by chenglong.cai for XR7215097 on 2018-12-24
                        //mStopTethering = false;
                        //End deleted by chenglong.cai for XR7215097 on 2018-12-24
                        clearWifiApClients();
                    } else {
                        handleWifiApClientsChanged();
                    }
    ...
    public void onStart() {
        ...
        //[TCT-ROM][Hotspot decoupling for P]Begin modified by yucheng.luo for XR7098003 on 18-11-15
        if(TctWifiSettingsUtils.getPlatformInfo() == 0) {
            getPreferenceManager().getPreferenceScreen().removePreference(mConnectedCategory);
            getPreferenceManager().getPreferenceScreen().removePreference(mBlockedCategory);
        ...
        //[TCT-ROM][Hotspot decoupling for P]End modified by yucheng.luo for XR7098003 on 18-11-15
    }
    ...
    private void clearWifiApClients() {
        ...
        connectedPreference.setSelectable(false);
        ...
        blockedPreference.setSelectable(false);
    ...
    private void handleWifiApClientsChanged() {
        ...
        //[TCT-ROM][Tethering Unblock]Begin added by yucheng.luo for XR7051529 & 7054243 on 18-10-29
        mBlockedCategory.removeAll();
        blockClientList = TctWifiSettingsUtils.getHotspotBlockedList(activity);
    ...
    public void onClick(View v, String deviceAddress,boolean block) {
        if (v.getId() == R.id.preference_button && deviceAddress != null) {
            if(block){
            //[TCT-ROM][Hotspot decoupling for P]Begin modified by yucheng.luo for XR7098003 on 18-11-26
                TctWifiSettingsUtils.setWifiHotspotUnblockClient(getContext(),deviceAddress);
            }else{
                TctWifiSettingsUtils.setWifiHotspotBlockClient(getContext(),deviceAddress);
            //[TCT-ROM][Hotspot decoupling for P]End modified by yucheng.luo for XR7098003 on 18-11-26
            }
    ...
    private void handleWifiApStateChanged(int state) {
        switch (state) {
            ...
            case WifiManager.WIFI_AP_STATE_ENABLED:
                ...
                //Begin added by yucheng.luo for XR7432748 on 19-1-29
                mStopTethering = false;
                //End added by yucheng.luo for XR7432748 on 19-1-29
                break;
