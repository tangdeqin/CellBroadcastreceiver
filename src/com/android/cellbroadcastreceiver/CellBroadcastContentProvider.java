...
public class CellBroadcastContentProvider extends ContentProvider {
    ...
    boolean insertNewBroadcast(CellBroadcastMessage message) {
        ...
        if (rowId == -1) {
            TLog.e(TAG, "failed to insert new broadcast into database");
    ...
    boolean deleteBroadcast(long rowId) {
        ...
        if (rowCount != 0) {
            ...
            TLog.e(TAG, "failed to delete broadcast at row " + rowId);
            return false;
        }
    }
    ...
    boolean deleteAllBroadcasts() {
        ...
        int rowCount;
        boolean cmasBroadcastAuthority = getContext().getResources().getBoolean(R.bool.def_cmasBroadcastAuthority);
        if(cmasBroadcastAuthority){
        	rowCount = db.delete(CellBroadcastDatabaseHelper.TABLE_NAME, Telephony.CellBroadcasts.SERVICE_CATEGORY + " not between 4370 and 4399" , null); // MODIFIED by yuxuan.zhang, 2016-09-20,BUG-2845457
        }else{
            rowCount = db.delete(CellBroadcastDatabaseHelper.TABLE_NAME, null, null);
        }
      //[BUGFIX]-MOD-end by chaobing.huang,9/22/2015,FR-1078247
        if (rowCount != 0) {
            return true;
        } else {
            TLog.e(TAG, "failed to delete all broadcasts");
            return false;
        }
    }
    ...
    boolean markBroadcastRead(String columnName, long columnValue) {
        ...
        if (rowCount != 0) {
            ...
            TLog.e(TAG, "failed to mark broadcast read: " + columnName + " = " + columnValue);
            return false;
        }
    }
        ...
        protected Void doInBackground(CellBroadcastOperation... params) {
            ...
            if (provider != null) {
                try {
                    ...
                    if (changed) {
                        TLog.d(TAG, "database changed: notifying observers...");
                ...
                TLog.e(TAG, "getLocalContentProvider() returned null");
            }
