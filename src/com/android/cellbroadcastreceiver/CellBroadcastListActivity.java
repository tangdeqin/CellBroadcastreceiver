...
/* MODIFIED-END by yuxuan.zhang,BUG-2845457*/
    ...
    public static class CursorLoaderListFragment extends ListFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setHasOptionsMenu(this.getResources().getBoolean(R.bool.def_show_options_menu));
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            menu.add(0, MENU_DELETE_ALL, 0, R.string.menu_delete_all).setIcon(
             ...
             //modify by deqin.tang for Defect 7140360 at 2018-11-22  begin
          ...
          //[FEATTURE]-MOD-END by TCTNB.Yugang.Jia,09/16/2013,FR-516039*/
                menu.add(0, MENU_PREFERENCES, 0, R.string.menu_preferences).setIcon(
                        android.R.drawable.ic_menu_preferences);
            //modify by deqin.tang for Defect 7140360 at 2018-11-22  end
        }
        ...
        public void onListItemClick(ListView l, View v, int position, long id) {
          ...
          //[FEATURE]-Add-BEGIN by TSCD.fujun.yang,08/25/2014,755265,SMSCB behavior in Android phones
            //begin PR899057-bujian-001 deleted
            /*
            if("true".equalsIgnoreCase(SystemProperties.get("ro.cb.channel50.brazil","false"))){
                TLog.i("CellBroadcastListActivity","ro.cb.channel50.brazil=true");
	            if(cbli.getMessage().getServiceCategory() == 50){
	                TLog.i("CellBroadcastListActivity","cbli.getMessage().getServiceCategory() == 50");
	                return;
	            }
            }*/
            //end PR899057-bujian-001 deleted
      ...
      //[BUGFIX]-MOD-BEGIN by chaobing.huang,9/22/2015,FR-1078247
        ...
        public Loader<Cursor> onCreateLoader(int id, Bundle args) {
            ...
            //[BUGFIX]-Mod-END by AMNJ.Bin.Huang, 2014/11/17, PR-842834
                    Telephony.CellBroadcasts.QUERY_COLUMNS, null, null, // MODIFIED by yuxuan.zhang, 2016-09-08,BUG-2845457
                    //[FEATURE]-Mod-Begin by TSNJ.wei.li,10/29/2014, FR-728852 Presidential msg are pinned to the top
                    mOrderBy);
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            switch(item.getItemId()) {
                ...
                case MENU_PREFERENCES:
                	boolean isShowCMASSettings = getResources().getBoolean(R.bool.def_show_cmas_settings_directly);
                    if (isShowCMASSettings) {
                    	Intent intent = new Intent(getActivity(), CellBroadcastSettings.class);
                        startActivity(intent);
                    } else {
                    	Intent intent = new Intent(getActivity(), GeneralPreference.class);
                        startActivity(intent);
                    }
                    break;
                    /* MODIFIED-END by yuxuan.zhang,BUG-1112693*/
